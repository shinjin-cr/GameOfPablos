...
processes.append(mp.Process(target = beat_experiment_varying_strategy_parameters_experiment, kwargs = kwargs))
#######################################################################################################################################################################
...
processes.append(mp.Process(target = beat_experiment_varying_initial_network_experiment, kwargs = kwargs))
